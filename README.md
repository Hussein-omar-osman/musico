...
1. Clone the repo
   ...
   ```shell
    git clone https://github.com/Hussein-omar-osman/musico.git
   ```
...
You've found a bug in the source code, a mistake in the documentation or maybe you'd like a new feature? You can help us by [submitting an issue on GitHub](https://github.com/orgs/Hussein-Omar-Osman/projects/8). Before you create an issue, make sure to search the issue archive -- your issue may have already been addressed!
...
4. Go to [Pull Requests](https://github.com/Hussein-Omar-Osman/musico/pulls) and click on the `New Pull Request` button.
